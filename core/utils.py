...
class utils:
    ...
    def banner():
        ...
        utils.Go("\t" + utils.Color['redBold'] + " / ______)           / _____)             ")
        utils.Go("\t" + utils.Color['redBold'] + "| |   ___ _____  ___( (____  ____  _   _  ")
        utils.Go("\t" + utils.Color['redBold'] + "| |  (_  | ___ |/ _ \\____ \|  _ \| | | | ")
        utils.Go("\t" + utils.Color['redBold'] + "| |____) | ____| |_| |____) ) |_| | |_| | ")
        utils.Go("\t" + utils.Color['redBold'] + " \______/|_____)\___(______/|  __/ \__  | ")
