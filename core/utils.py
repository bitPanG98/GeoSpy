...
class utils:
    ...
    def banner():
        ...
        utils.Go("\t" + utils.Color['redBold'] + " _______             ______             ")
        utils.Go("\t" + utils.Color['redBold'] + "(_______)           / _____)            ")
        utils.Go("\t" + utils.Color['redBold'] + " _   ___ _____  ___( (____  ____  _   _ ")
        utils.Go("\t" + utils.Color['redBold'] + "| | (_  | ___ |/ _ \\____ \|  _ \| | | |")
        utils.Go("\t" + utils.Color['redBold'] + "| |___) | ____| |_| |____) ) |_| | |_| |")
        utils.Go("\t" + utils.Color['redBold'] + " \_____/|_____)\___(______/|  __/ \__  |")
    ...
    def checkOS():
        if "posix" in os.name:
            ...
            pass
        utils.Go("Loading" + " " + utils.Color['blue'] + "GeoSpy" + utils.Color['white'] + "...")
        time.sleep(0.4)
    ...
    # Local port check to allow GeoSpy to run    
    @staticmethod
    def checkPort(port):
        try:
